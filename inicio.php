            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="javascript:void(0)"><i class="fa fa-home"></i>Inicio<span class="label label-success pull-right"></span></a></li>
                </ul>
              </div>
              ...
              <div class="menu_section">
                <h3>REPORTES</h3>
                <ul class="nav side-menu">
                  <li><a href="javascript:void(0)"><i class="fa fa-home"></i>Reportar mi Basura<span class="label label-success pull-right"></span></a></li>
                </ul>

                <ul class="nav side-menu">
                  <li><a href="javascript:void(0)"><i class="fa fa-home"></i>Mi Reciclaje<span class="label label-success pull-right"></span></a></li>
                </ul>
                ...
                <div class="x_content">
                  <div class="dashboard-widget-content">
                    <ul class="quick-list">
                      ...
                      <li><i class="fa fa-area-chart"></i><a href="login.php">Logout</a>
                      </li>
                    </ul>
            ...
            <div class="col-md-8 col-sm-8 ">
              <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>Mostrar Ubicacion de<small>todos los reportes</small></h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="dropdown">
                    ...
                    <div class="x_content">
                      <div class="dashboard-widget-content">
                        <div class="col-md-4 hidden-small">
                          <h2 class="line_30">Tus Reportes Totales</h2>

                          <table class="countries_list">
                            <tbody>
                              <tr>
                                <td>Calle 021</td>
                                <td class="fs15 fw700 text-right"><a href="https://www.google.com.pe/maps/@-6.490649,-76.3547801,3a,75y,55.08h,90t/data=!3m7!1e1!3m5!1sai3huf5_cDvSz9ji-hy4bA!2e0!6shttps:%2F%2Fstreetviewpixels-pa.googleapis.com%2Fv1%2Fthumbnail%3Fpanoid%3Dai3huf5_cDvSz9ji-hy4bA%26cb_client%3Dsearch.revgeo_and_fetch.gps%26w%3D96%26h%3D64%26yaw%3D55.07839%26pitch%3D0%26thumbfov%3D100!7i13312!8i6656?hl=es-419" data-toggle="tooltip" data-placement="top" title="Visualizar Dirección"><span class="glyphicon glyphicon-eye-close" aria-hidden="true"></span></a></td>
                              </tr>
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>Lista de tareas <small>Pendientes</small></h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="">
                    ...
                    <div class="x_content">
                      ...
                      <div class="">
                        <ul class="to_do">
                          ...
                          <li>
                            <p>
                              <input type="checkbox" class="flat"> Basura en la calle 000 </p>
                          </li>
