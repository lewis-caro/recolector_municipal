...
<html lang="en">
  ...
  <body>
            ...
            <div class="row g-5">
              <div class="col-12 col-sm-6 col-lg-12">
                <div class="border-start ps-4">
                  ...
                  <i><span> Queridos pobladores el horario de recojo de la basura es a partir de las 3:00 am por favor tener lista su basura fuera de la casa para evitar incovenientes. </span></i>
                </div>
              </div>
        ...
        <div class="row g-5 align-items-center">
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <p class="mb-4" text-align>
              La denominada Regla de las Tres Erres pretende estimular la participación ciudadana, desde el ámbito del hogar, en la lucha contra la degradación del planeta mediante la reducción, la reutilización y el reciclaje de los
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="service-item rounded d-flex h-100">
              ...
              <div class="service-text rounded p-5">
                ...
                <p class="mb-4">
                  Es un sistema intersectorial del Gobierno Peruano que provee información socioeconómica a las intervenciones públicas y programas sociales para la identificación de sus potenciales usuarios, en beneficio de aquellos grupos
            ...
            <div class="bg-white rounded p-4 p-sm-5 wow fadeIn" data-wow-delay="0.5s">
              ...
              <form name="formulario-registro-civil" id="formulario-registro-civil" method="post">
                <div class="row g-3">
                  ...
                  <div class="col-sm-6">
                    <div class="form-floating form-group">
                      <input type="number" class="form-control bg-light border-0" id="celular" name="celular" placeholder="Celular" required />
                  ...
                  <div class="col-sm-6">
                    <div class="form-floating form-group">
                      <input type="text" class="form-control bg-light border-0" id="usuario" name="usuario" placeholder="Usuario" required />
                  ...
                  <div class="col-12 text-center">
                    <input type="submit" name="registrar-civil" id="registrar-civil" class="btn btn-primary py-3 px-4" value="registrar" />
                  </div>
      ...
      <div class="container py-5">
        <div class="row g-5">
          <div class="col-lg-3 col-md-6">
            ...
            <a href="https://goo.gl/maps/GVM98msBzqWUBqaK6">
              <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jr. Yurimaguas No. 340</p>
            </a>
            <br />
    ...
    <div class="container-fluid copyright py-4">
      <div class="container">
        <div class="row">
          <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">&copy; <a class="border-bottom" href="#">nuestro site web</a>, gracias por visitarnos.</div>
